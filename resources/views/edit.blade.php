...
<body class="bg-gray-50 text-gray-800">
    <div class="container">
        ...
        <div class="flex items-center justify-between py-6">
            <h1 class="text-xl font-bold text-gray-700">Edit - {{ $ourPost->name }}</h1>
            ...
            <form method="POST" action="{{ route('update', $ourPost->id) }}" enctype="multipart/form-data">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ $ourPost->name }}" class="form-input" placeholder="Enter name">
                        @error('name')
                    ...
                    <div>
                        ...
                        <textarea name="description" class="form-input" rows="4" placeholder="Enter description">{{ $ourPost->description }}</textarea>
                        @error('description')
                        <p class="error-text">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        @enderror
                        <div class="mt-4">
                            <img id="imagePreview" src="{{ asset('images/' . $ourPost->image) }}" alt="Current Image" class="w-32 h-32 object-cover rounded-md">
                        </div>
                    </div>
